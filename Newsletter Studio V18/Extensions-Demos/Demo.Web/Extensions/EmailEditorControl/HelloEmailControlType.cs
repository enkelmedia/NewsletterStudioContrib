    ...
    : EmailControlTypeBase<HelloEmailControlData, HelloEmailControlViewModel>
{
    ...
    public override Task<HelloEmailControlViewModel> DoBuildViewModelAsync(
        HelloEmailControlData model,
        RenderingContext renderingData
        )
    {
    ...
    public override Task<HelloEmailControlViewModel> DoUpdateUniqueViewModelAsync(
        ...
        )
    {
        ...
        // will be a clone of the result from the DoBuildViewModelAsync-method.
