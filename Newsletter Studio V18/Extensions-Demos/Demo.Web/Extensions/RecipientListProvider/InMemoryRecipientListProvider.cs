...
public class InMemoryRecipientListProvider : IRecipientListProvider
{
    ...
    /// <returns></returns>
    public Task<List<RecipientList>> GetListsAsync(Guid workspaceKey)
    {
        /*
         ...
         */
        return Task.FromResult(new List<RecipientList>()
        {
            new RecipientList()
            {
    ...
    /// <see cref="GetListsAsync"/>-method is passed here and will contain your
    /// unique identifier.
    ///
    ...
    /// <returns></returns>
    public Task<List<EmailReceiver>> GetReceiversForListAsync(
    ...
    /// <see cref="GetReceiversForListAsync"/>-method.
    ///
    ...
    /// <returns></returns>
    public Task<RecipientProviderRecipientDataModel> GetDataModelAsync(
    ...
    public Task<EmailReceiver> GetByEmailAsync(string email, Guid? workspaceKey = null)
    {
    ...
    /// <param name="receiverId"></param>
    /// <returns></returns>
    public Task<bool> UnsubscribeAllAsync(EmailReceiverIdentifier receiverId)
    {
        //TODO: Change status
        return Task.FromResult(true);
    }
    ...
    /// <param name="receiverId"></param>
    /// <returns></returns>
    public Task<RecipientEditInformation?> GetEditInformationAsync(
        EmailReceiverIdentifier receiverId
        )
    {
        return Task.FromResult<RecipientEditInformation?>(new RecipientEditInformation()
        {
    ...
    /// <inheritdoc />
    public Task ReportSoftBounceAsync(EmailReceiverIdentifier receiverId)
    {
    ...
    /// <inheritdoc />
    public Task ReportHardBounceAsync(EmailReceiverIdentifier receiverId)
    {
