...
import { NsPaddingChangedEvent } from "@newsletterstudio/umbraco/components";
            ...
            <div>
                ...
                <ns-property label="ns_margin">
                    <ns-padding-editor
                        ...
                        @change=${(e : NsPaddingChangedEvent)=>this.updateModel({padding:e.detail})}></ns-padding-editor>
                </ns-property>
            </div>
        `;
    }
